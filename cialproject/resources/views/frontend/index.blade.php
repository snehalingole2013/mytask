...
<div class="header_right">
  <img src="{{url('frontend/images/banner-img.png')}}" class="banner_img">
</div>
</div>
    <!--about section start -->
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-8">
            ...
            <div class="moremore_bt"><a href="{{url('/')}}">Read More </a></div>
          </div>
          <div class="col-md-4">
            <div><img src="{{url('frontend/images/img-1.png')}}" class="image_1"></div>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="container">
        ...
        <div class="what_we_do_section_2">
          ...
          <div class="col-lg-3 col-sm-6">
            <div class="box_main">
              <div class="icon_1"><img src="{{url('frontend/images/icon-1.png')}}"></div>
          ...
          <div class="col-lg-3 col-sm-6">
            <div class="box_main active">
              <div class="icon_1"><img src="{{url('frontend/images/icon-2.png')}}"></div>
          ...
          <div class="col-lg-3 col-sm-6">
            <div class="box_main">
              <div class="icon_1"><img src="{{url('frontend/images/icon-3.png')}}"></div>
          ...
          <div class="col-lg-3 col-sm-6">
            <div class="box_main">
              <div class="icon_1"><img src="{{url('frontend/images/icon-4.png')}}"></div>
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="project_main">
              ...
              <div class="image_6"><img src="{{url('frontend/images/img-6.png')}}"></div>
            </div>
          </div>
          <div class="col-md-6">
            <div class="images_main">
              <div class="images_left">
                <div class="container_1">
                  <img src="{{url('frontend/images/img-2.png')}}" alt="Avatar" class="image" style="width:100%">
                  <div class="middle">
                    <div class="text"><img src="{{url('frontend/images/search-icon.png')}}"></div>
                    <h2 class="fact_text">Established Fact</h2>
                  </div>
                </div>
                <div class="container_1">
                  <img src="{{url('frontend/images/img-3.png')}}" alt="Avatar" class="image" style="width:100%">
                  <div class="middle">
                    <div class="text"><img src="{{url('frontend/images/search-icon.png')}}"></div>
                    <h2 class="fact_text">Established Fact</h2>
                  </div>
              ...
              <div class="images_right">
                <div class="container_1">
                  <img src="{{url('frontend/images/img-4.png')}}" alt="Avatar" class="image" style="width:100%">
                  <div class="middle">
                    <div class="text"><img src="{{url('frontend/images/search-icon.png')}}"></div>
                    <h2 class="fact_text">Established Fact</h2>
                  </div>
                ...
                <div class="container_1">
                  <img src="{{url('frontend/images/img-5.png')}}" alt="Avatar" class="image" style="width:100%">
                  <div class="middle">
                    <div class="text"><img src="{{url('frontend/images/search-icon.png')}}"></div>
                    <h2 class="fact_text">Established Fact</h2>
                  </div>
          ...
          <div class="carousel-inner">
            <div class="carousel-item active">
              ...
              <div class="client_section_2 layout_padding">
                <ul>
                  <li><img src="{{url('frontend/images/round-1.png')}}" class="round_1"></li>
                  <li><img src="{{url('frontend/images/img-11.png')}}" class="image_11"></li>
                  <li><img src="{{url('frontend/images/round-2.png')}}" class="round_2"></li>
                </ul>
